...
def create_app():
    ...
    #블루프린트 등록
    from .views import main_views,question_views, answer_views,auth_views,comment_views # auth_views 추가
    app.register_blueprint(main_views.bp)
    app.register_blueprint(question_views.bp)
    app.register_blueprint(answer_views.bp)
    app.register_blueprint(auth_views.bp) # 등록 완료
    # jinja_env 필터에 등록
    app.jinja_env.filters['datetime'] = format_datetime
    app.register_blueprint(comment_views.bp) # 등록 완료
